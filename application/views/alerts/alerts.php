...
<body class="hold-transition sidebar-mini layout-fixed ">
  ...
  <div id='hiddenvalues'>
    ...
    $baseurl = base_url();
    $hiddenids = array();
    array_push($hiddenids,'swiperdone', 'baseurl', 'propvalues', 'bodyswiperinit', 'bodyswiper', 'selectallcheckbox', 'activealerttab', 'alerttabconnect', 'alertsfilter', 'alertsresult', 'checkboxon', 'cardclickon');
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand  navbar-dark nvc " style="background-color: #2cbebb;">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <!-- Notifications Dropdown Menu href="alertspage?propid=<?php echo $propid ?>" -->
        <li class="nav-item dropdown">
          <a class="nav-link" href="alertspage?propid=<?php echo $propid ?>" id="alertspage-link">
    ...
    <div class="content-wrapper" style="margin-top: 62px;background-color: white;">
      ...
      <section id="alertscontent" class="content pn">
        ...
        <div class="tab-content" style="margin-top: 5px;position: relative;">
          ...
          <div id="alerttabs-content-unread" style="height:100vh" class="container tab-pane active alerttabs-content">
          </div>
          <div id="alerttabs-content-read" style="height:100vh" class="container tab-pane fade alerttabs-content">
          </div>
          <div id="alerttabs-content-all" style="height:100vh" class="container tab-pane fade alerttabs-content">
          </div>
