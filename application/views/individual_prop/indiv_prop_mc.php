...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light nvc">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link <?php //echo $unhide; ?> hide" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
       
        <a class="nav-link <?php //echo $hide; ?>"  href="indiv_back" role="button"><i class="fas fa-arrow-left"></i></a>
      </li>
