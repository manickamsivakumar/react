...
p.norecords {
    ...
    padding: 10px;
        ...
        #indiv_cards {
          ...
          box-shadow: rgb(0 0 0 / 0%) 0px 2px 4px, rgb(0 0 0 / 17%) 0px 7px 13px -3px, rgb(0 0 0 / 20%) 0px 1px 0px inset;*/
          ...
          padding:4px;margin-left: 0px;">
                    ...
                    <div class="row" style="margin: 0px;">
                        ...
                        <div class="col-6 mt-1">
                            <span class="t1d">Day Settlement</span>
                            <span class="t2d"></span>
                        </div>
                        <div class="col-6">
                            <!-- select -->
                            <div class="form-group" style="margin-bottom: 0px!important;">
                                <input type="date" value="" class="form-control" id="mydate">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-credit-tab" data-toggle="pill" href="#pills-credit" role="tab" aria-controls="pills-credit" aria-selected="false">Credit</a>
                            </li>
                        </ul>

                    </div>
                </div>
                <div class="row" style="background-color:#17a2b8;position: relative;top: -16px;">
                   <div class="col-6 balance"  >
                      <span class="bal_head">opening balance</span><br/>
                       <span class="balamount" id="openingbalance">1223</span>
                     </div>
                    <div class="col-6 balance">
                       <span class="bal_head">closing balance</span><br/>
                       <span class="balamount" id="closeingbalance">32345</span>
            ...
            <!-- ./wrapper -->
            <script src="<?php echo base_url(); ?>assets/js/settle.js"></script>
