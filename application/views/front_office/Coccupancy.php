...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    text-align: initial;">
        ...
        <div class="content-wrapper" style="margin-top: 110px; background-color: white">
                ...
                <div class="main-header " style="width:100%;background-color: #5cd2fd;
                    ...
                    <div class="row" style="margin: 0px;">
                        ...
                        <div class="col-6 mt-1">
                            <span class="t1d">Current Occupancy</span>
                            <span class="t2d"></span>
                        </div>
                        <div class="col-6">
                            <!-- select -->
            ...
            <div class="col-12"  id="currentoccupancysection" style="padding: 0 20px;">
    ...
    <!-- ./wrappe-->
    <script src="<?php echo base_url(); ?>assets/js/occupancy.js"></script>
