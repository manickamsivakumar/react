...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <nav class="main-header navbar navbar-expand navbar-dark nvc" style="background-color: #2cbebb">
            ...
            <ul class="navbar-nav" style="width:20%">
                <li class="nav-item">
                    ...
                    <a class="nav-link pln" href="occupancy?propid=<?php echo $propid ; ?>" role="button"><i class="fas fa-arrow-left"></i></a>
                </li>
            </ul>
    ...
    text-align: initial;">
        ...
        <div class="content-wrapper" style="background-color: white; margin-top:100px; min-height:615px !important;">
            <!-- Main content -->
            <!-- Main content -->
            <header id="header">
