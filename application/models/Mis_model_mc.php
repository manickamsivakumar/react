...
Class Mis_model extends CI_Model
{
    ...
    public function get_all_module_values($fromdate,$todate)
    {
        ...
        foreach($data as $key => $value)
        {
            ...
            {
                $main_page_all_data[$key]['pos_total_bill_amount']="0";
            }
            //get bnqt_amount
            ...
            {
                $main_page_all_data[$key]['bnqt_total_booking_charges_amount']="0";
            }
           $frontoffice= $this->frontoffice($fromdate,$todate,$dbname);

           /*$alertandauth= $this->alertandauth($fromdate,$todate,$propid,$dbname,$cmpid);
           $main_page_all_data[$key]['alertcount']= $alertcount;
            $main_page_all_data[$key]['authcount']=$authcount;*/
